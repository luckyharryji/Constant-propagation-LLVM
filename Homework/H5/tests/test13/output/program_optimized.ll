...
@.str = private unnamed_addr constant [14 x i8] c"Values: %lld\0A\00", align 1
...
define void @function_that_complicates_everything(i8** %par1) #0 {
  %1 = load i8*, i8** %par1, align 8
  %2 = load i8*, i8** %par1, align 8
  %3 = load i8*, i8** %par1, align 8
...
define i32 @main(i32 %argc, i8** %argv) #0 {
  ...
  %4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i32 0, i32 0), i64 %3)
  ret i32 0
}
