...
@.str.1.6 = private unnamed_addr constant [31 x i8] c"libCAT: ERROR = input is NULL\0A\00", align 1
@.str.2.7 = private unnamed_addr constant [41 x i8] c"libCAT: ERROR = data has been corrupted\0A\00", align 1

; Function Attrs: nounwind uwtable
define i32 @main(i32 %argc, i8** %argv) #0 {
  %1 = call noalias i8* @malloc(i64 8) #5
  ...
  %10 = call i64 @CAT_get_signed_value(i8* %3)
  %11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.2, i32 0, i32 0), i64 %10)
  %12 = load i8*, i8** %2, align 8
  %13 = load i8*, i8** %2, align 8
  %14 = load i8*, i8** %2, align 8
  call void @CAT_binary_add(i8* %12, i8* %13, i8* %14)
  %15 = call i64 @CAT_get_signed_value(i8* %5)
  %16 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i32 0, i32 0), i64 %15)
  %17 = call i64 @CAT_get_signed_value(i8* %4)
  %18 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.1, i32 0, i32 0), i64 %17)
  %19 = call i64 @CAT_get_signed_value(i8* %3)
  %20 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.2, i32 0, i32 0), i64 %19)
  ret i32 0
}
...
; Function Attrs: nounwind uwtable
define noalias i8* @CAT_create_signed_value(i64 %value) #3 {
...
; Function Attrs: nounwind uwtable
define i64 @CAT_get_signed_value(i8* readonly %v) #3 {
...
; Function Attrs: nounwind uwtable
define internal fastcc %struct.internal_data_t* @internal_check_data(i8* readonly %v) unnamed_addr #3 {
  %1 = icmp eq i8* %v, null
  br i1 %1, label %2, label %5

; <label>:2                                       ; preds = %0
  %3 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !6
  %4 = tail call i64 @fwrite(i8* nonnull getelementptr inbounds ([31 x i8], [31 x i8]* @.str.1.6, i64 0, i64 0), i64 30, i64 1, %struct._IO_FILE* %3) #8
...
; <label>:13                                      ; preds = %9, %5
  ...
  %15 = tail call i64 @fwrite(i8* nonnull getelementptr inbounds ([41 x i8], [41 x i8]* @.str.2.7, i64 0, i64 0), i64 40, i64 1, %struct._IO_FILE* %14) #8
  tail call void @abort() #9
  unreachable
...
; Function Attrs: nounwind uwtable
define void @CAT_binary_sub(i8* %result, i8* readonly %v1, i8* readonly %v2) #3 {
...
; Function Attrs: nounwind uwtable
define void @CAT_binary_add(i8* %result, i8* readonly %v1, i8* readonly %v2) #3 {
  %1 = tail call fastcc %struct.internal_data_t* @internal_check_data(i8* %v1)
  %2 = tail call fastcc %struct.internal_data_t* @internal_check_data(i8* %v2)
  %3 = tail call fastcc %struct.internal_data_t* @internal_check_data(i8* %result)
  %4 = getelementptr inbounds %struct.internal_data_t, %struct.internal_data_t* %1, i64 0, i32 1
