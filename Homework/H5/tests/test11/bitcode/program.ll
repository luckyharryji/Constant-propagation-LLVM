...
; <label>:5                                       ; preds = %3, %1
  %.0 = phi i8* [ %4, %3 ], [ %.1, %1 ]
  %6 = call i64 @CAT_get_signed_value(i8* %.0)
  %7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str, i32 0, i32 0), i64 %6)
  ret void

; <label>:8                                       ; preds = %13
  %9 = icmp sgt i32 %argc, 10
  br i1 %9, label %10, label %12

; <label>:10                                      ; preds = %8
  %11 = call i8* @CAT_create_signed_value(i64 8)
  br label %12
...
; <label>:13                                      ; preds = %0
  %14 = call i8* @CAT_create_signed_value(i64 8)
  br label %8
}
