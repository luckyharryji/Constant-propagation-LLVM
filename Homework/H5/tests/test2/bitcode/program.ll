...
@.str.5 = private unnamed_addr constant [21 x i8] c"p6pbbUlpLo0BL1bM2k8K\00", align 1
@stderr = external global %struct._IO_FILE*, align 8
@.str.1.8 = private unnamed_addr constant [31 x i8] c"libCAT: ERROR = input is NULL\0A\00", align 1
@.str.2.9 = private unnamed_addr constant [41 x i8] c"libCAT: ERROR = data has been corrupted\0A\00", align 1
...
; <label>:8                                       ; preds = %4
  %9 = call i64 @CAT_get_signed_value(i8* %1)
  %10 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.2, i32 0, i32 0), i64 %9)
  br label %11

; <label>:11                                      ; preds = %8, %4
  %12 = call i8* @CAT_create_signed_value(i64 0)
  call void @CAT_binary_add(i8* %12, i8* %d1, i8* %1)
  %13 = call i64 @CAT_get_signed_value(i8* %12)
  %14 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.3, i32 0, i32 0), i64 %13)
  ret void
}
...
define noalias i8* @CAT_create_signed_value(i64 %value) #2 {
  ...
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* %1, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.5, i64 0, i64 0), i64 20, i32 1, i1 false)
  %2 = getelementptr inbounds i8, i8* %1, i64 32
  tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* %2, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.5, i64 0, i64 0), i64 20, i32 1, i1 false)
...
; <label>:2                                       ; preds = %0
  ...
  %4 = tail call i64 @fwrite(i8* nonnull getelementptr inbounds ([31 x i8], [31 x i8]* @.str.1.8, i64 0, i64 0), i64 30, i64 1, %struct._IO_FILE* %3) #8
  tail call void @abort() #9
  unreachable

; <label>:5                                       ; preds = %0
  %6 = bitcast i8* %v to %struct.internal_data_t*
  %7 = tail call i32 @strncmp(i8* nonnull %v, i8* nonnull getelementptr inbounds ([21 x i8], [21 x i8]* @.str.5, i64 0, i64 0), i64 20) #10
  %8 = icmp eq i32 %7, 0
  br i1 %8, label %9, label %13

; <label>:9                                       ; preds = %5
  %10 = getelementptr inbounds i8, i8* %v, i64 32
  %11 = tail call i32 @strncmp(i8* %10, i8* nonnull getelementptr inbounds ([21 x i8], [21 x i8]* @.str.5, i64 0, i64 0), i64 20) #10
  %12 = icmp eq i32 %11, 0
  br i1 %12, label %16, label %13

; <label>:13                                      ; preds = %9, %5
  %14 = load %struct._IO_FILE*, %struct._IO_FILE** @stderr, align 8, !tbaa !6
  %15 = tail call i64 @fwrite(i8* nonnull getelementptr inbounds ([41 x i8], [41 x i8]* @.str.2.9, i64 0, i64 0), i64 40, i64 1, %struct._IO_FILE* %14) #8
  tail call void @abort() #9
  unreachable
