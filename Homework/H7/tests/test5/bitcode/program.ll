...
define void @p(i64 %v, i8* %d) #0 {
  %1 = icmp eq i64 %v, 0
  br i1 %1, label %2, label %4

; <label>:2                                       ; preds = %0
  %3 = call i8* @CAT_create_signed_value(i64 1)
  call void @CAT_binary_add(i8* %d, i8* %d, i8* %3)
  br label %8

; <label>:4                                       ; preds = %0
  %5 = add i64 %v, 5
  %6 = call i8* @CAT_create_signed_value(i64 %5)
  call void @CAT_binary_add(i8* %d, i8* %d, i8* %6)
  %7 = sub i64 %v, 1
  call void @p(i64 %7, i8* %d)
  br label %8
...
; <label>:2                                       ; preds = %8, %0
  %i.0 = phi i32 [ 1, %0 ], [ %9, %8 ]
  %3 = icmp sle i32 %i.0, 5
  br i1 %3, label %4, label %10

; <label>:4                                       ; preds = %2
  %5 = sext i32 %i.0 to i64
  call void @p(i64 %5, i8* %1)
  %6 = call i64 @CAT_get_signed_value(i8* %1)
