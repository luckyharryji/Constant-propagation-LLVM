...
namespace {
  struct CAT : public FunctionPass {
    ...
    bool runOnFunction (Function &F) override {
      ...
      for (auto& B : F) {
        for (auto& I : B) {
          if (auto* call = dyn_cast<CallInst>(&I)) {
            ...
            Value *mul = builder.CreateFMul(inputValue, constValue, "MulToSubstituteSQRT");

            // Remove a fraction of the input value
            Value *sub = builder.CreateFSub(inputValue, mul, "SubToSubstituteSQRT");
            ...
            Value *add = builder.CreateFAdd(sub, const1Value, "AddToSubstituteSQRT");
      ...
      // Validate the code
      errs() << "CATPass:   Verify the LLVM bitcode in the current function\n";
      verifyFunction(F);
      errs() << "CATPass:     Passed\n" ;
