...
; <label>:1                                       ; preds = %8
  %2 = call i64 @CAT_get_signed_value(i8* %.0)
  %3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str, i32 0, i32 0), i64 %2)
  ret void

; <label>:4                                       ; preds = %9
  %5 = icmp sgt i32 %argc, 10
  br i1 %5, label %6, label %8

; <label>:6                                       ; preds = %4
  %7 = call i8* @CAT_create_signed_value(i64 8)
  br label %8
...
; <label>:9                                       ; preds = %0
  %10 = call i8* @CAT_create_signed_value(i64 8)
  br label %4
}
