...
define i8* @p() #0 {
  %1 = call i8* @CAT_create_signed_value(i64 1)
  ret i8* %1
}
...
define i32 @main(i32 %argc, i8** %argv) #0 {
  %1 = call i8* @p()
  %2 = call i8* @p()
  %3 = call i64 @CAT_get_signed_value(i8* %1)
  %4 = call i64 @CAT_get_signed_value(i8* %2)
  %5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0), i64 %3, i64 %4)
  ret i32 0
}
