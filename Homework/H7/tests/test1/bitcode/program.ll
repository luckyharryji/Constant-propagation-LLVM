...
define i8* @p(i8* %v) #0 {
  %1 = call i64 @CAT_get_signed_value(i8* %v)
  %2 = icmp slt i64 %1, 10
  br i1 %2, label %3, label %5

; <label>:3                                       ; preds = %0
  %4 = call i8* @CAT_create_signed_value(i64 1)
  br label %7

; <label>:5                                       ; preds = %0
  %6 = call i8* @CAT_create_signed_value(i64 2)
  br label %7
...
define i32 @main(i32 %argc, i8** %argv) #0 {
  %1 = call i8* @CAT_create_signed_value(i64 7)
  %2 = call i8* @p(i8* %1)
  %3 = call i8* @CAT_create_signed_value(i64 80)
  %4 = call i8* @p(i8* %3)
  %5 = call i64 @CAT_get_signed_value(i8* %2)
  %6 = call i64 @CAT_get_signed_value(i8* %4)
  %7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str, i32 0, i32 0), i64 %5, i64 %6)
  ret i32 0
}
