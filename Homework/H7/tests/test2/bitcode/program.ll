...
define i8* @p(i32 %value) #0 {
  %1 = icmp sgt i32 %value, 10
  br i1 %1, label %2, label %4

; <label>:2                                       ; preds = %0
  %3 = call i8* @CAT_create_signed_value(i64 5)
  br label %6

; <label>:4                                       ; preds = %0
  %5 = call i8* @CAT_create_signed_value(i64 6)
  br label %6
...
; Function Attrs: nounwind uwtable
define i8* @q1(i32 %valueQ) #0 {
  %1 = call i8* @p(i32 1)
  ret i8* %1
}

; Function Attrs: nounwind uwtable
define i8* @q2(i32 %valueQ) #0 {
  %1 = add nsw i32 %valueQ, 8
  %2 = call i8* @p(i32 %1)
  ret i8* %2
}

; Function Attrs: nounwind uwtable
define i8* @q3(i32 %valueQ) #0 {
  %1 = add nsw i32 %valueQ, 1
  %2 = call i8* @p(i32 %1)
  ret i8* %2
}
...
define i32 @main(i32 %argc, i8** %argv) #0 {
  ...
  %2 = call i8* @q2(i32 3)
  %3 = call i8* @q3(i32 1)
  %4 = call i64 @CAT_get_signed_value(i8* %1)
  %5 = call i64 @CAT_get_signed_value(i8* %2)
  %6 = call i64 @CAT_get_signed_value(i8* %3)
  %7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str, i32 0, i32 0), i64 %4, i64 %5, i64 %6)
  ret i32 0
}
