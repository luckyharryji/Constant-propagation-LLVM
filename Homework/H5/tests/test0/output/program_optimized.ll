...
@.str = private unnamed_addr constant [21 x i8] c"H1: \09Value 2 = %lld\0A\00", align 1
@.str.1 = private unnamed_addr constant [20 x i8] c"H1: \09Result = %lld\0A\00", align 1
...
define void @CAT_execution(i8* %d1) #0 {
  ...
  %2 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str, i32 0, i32 0), i64 8)
  %3 = call i8* @CAT_create_signed_value(i64 0)
  call void @CAT_binary_add(i8* %3, i8* %d1, i8* %1)
  %4 = call i64 @CAT_get_signed_value(i8* %3)
  %5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i32 0, i32 0), i64 %4)
  ret void
}
