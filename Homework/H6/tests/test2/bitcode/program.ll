...
define i32 @main(i32 %argc, i8** %argv) #0 {
  ...
  call void @CAT_binary_add(i8* %9, i8* %5, i8* %5)
  %10 = call i64 @CAT_get_signed_value(i8* %5)
  %11 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str, i32 0, i32 0), i64 %10)
