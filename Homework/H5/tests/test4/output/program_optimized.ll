...
define i32 @main(i32 %argc, i8** %argv) #0 {
  ...
  %2 = call i8* @CAT_create_signed_value(i64 9)
  %3 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i32 0, i32 0), i64 9)
  call void @CAT_binary_add(i8* %2, i8* %2, i8* %2)
  %4 = call i64 @CAT_get_signed_value(i8* %2)
  %5 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str, i32 0, i32 0), i64 %4)
  ret i32 0
}
