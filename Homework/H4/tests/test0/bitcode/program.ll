...
; <label>:7                                       ; preds = %6, %0
  ...
  %9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.1, i32 0, i32 0), i64 %8)
  %10 = call i8* @CAT_create_signed_value(i64 0)
  call void @CAT_binary_add(i8* %10, i8* %1, i8* %4)
  %11 = call i64 @CAT_get_signed_value(i8* %10)
  %12 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.2, i32 0, i32 0), i64 %11)
  ret void
}
